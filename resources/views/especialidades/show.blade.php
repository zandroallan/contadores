@extends('layouts.app')
    ...
    @section('breadcrumb')
            ...
            <div class="account-container">
                <div class="account-body">
                    <div class="policy-info">
                        <h4>
                            <i class="fab fa-slideshare fa-fw text-primary"></i> Listado de cursos asignado al grupo 
                        </h4>
                        <p>
        ...
        @section('js')
            ...
            <!-- Personal Js-Script -->
            <script src="{{ asset('public/views/grupos/show.js') }}"></script>
