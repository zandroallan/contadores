    @extends('layouts.app')
        ...
        @section('title')
            ...
            <h1 class="h3 fw-bold mb-0">Orden del día</h1>
        ...
        @section('content')
            ...
            <div class="block block-themed">
                <div class="block-header bg-flat-dark">
                    <h3 class="block-title">Datos de la sesión</h3>
                    ...
                    <form name="frm-sesion-update" id="frm-sesion-update">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">                                
                                ...
                                <div class="row items-push">
                                    <div class="col-md-12">
                                        <div class="form-check form-block">
                                            <label class="form-check-label bg-success-light" for="example-checkbox-block1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-block">
                                            <label class="form-check-label bg-success-light" for="example-checkbox-block2">
                                                <span class="d-flex align-items-center">
                                                    <i class="fa fa-2x fa-calendar-days"></i>
                                                    <span class="ms-2">
                                ...
                                <h6 class="border-bottom pb-2">Orden del día de la sesión</h6>
        ...
        @section('js')
            ...
            <script src="{{ asset('public/views/sesiones/show.js') }}"></script>
