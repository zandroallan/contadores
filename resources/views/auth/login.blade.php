...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <script src="{{ asset('public/template/assets/js/oneui.app.min.js') }}">
        </script>
        <script src="{{ asset('public/template/assets/js/lib/jquery.min.js') }}">
        </script>
        <script src="{{ asset('public/template/assets/js/plugins/jquery-validation/jquery.validate.min.js') }}">
        </script>
        <!-- Page JS Code -->
        <script src="{{ asset('public/template/assets/js/pages/op_auth_signup.min.js') }}">
        </script>
    </body>
</html>