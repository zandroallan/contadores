            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                    ...
                    <a class="btn btn-inverse btn-theme btn-usuario-update" href="#">
                        <i class="text-primary fa fa-save"></i>  Editar rtec
                    </a>
                </div>
            </div>
            @endcan
        ...
        @section('content')
            ...
            <div class="checkout">
                <div class="checkout-header" style="color: #fff;">
                    <h4 >
                        <i class="fab fa-slideshare fa-fw text-primary"></i> Actualización de rtec
                    </h4>
                    <p>
                        Este procedimiento es esencial para mantener la base de datos de usuarios actualizada, asegurando que los registros sean precisos y reflejen de manera correcta las condiciones actuales de cada RTEC.
                    </p>
                </div>
                <div class="checkout-body">                    
                    <form name="frm-rtec-update" id="frm-rtec-update">
