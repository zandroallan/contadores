        ...
        <?php $__env->startSection('breadcrumb'); ?>
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a class="link-fx" href="<?php echo e(route('roles.index')); ?>">
                    Roles de Usuarios
                </a>
            </li>
        ...
        <?php $__env->startSection('button-action'); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                    <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-inverse btn-theme">
                        Crear nuevo rol
                    </a>
                </div>
            </div>
        ...
        <?php $__env->startSection('js'); ?>  
            ...
            <script src="<?php echo e(asset('public/views/roles/index.js')); ?>"></script>
        <?php $__env->stopSection(); ?>
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppServ\www\contadores\resources\views/roles/index.blade.php ENDPATH**/ ?>